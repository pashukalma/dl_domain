...
🛠 Core Utilities
dl_modules.py: The engine of the repository. It contains shared classes, custom PyTorch/Lightning wrappers, and utility functions (e.g., Classifier, Trainer, and evaluation metrics like BLEU) used across all notebooks to ensure code modularity and readability.
...
Python 3.8+; PyTorch & Torchvision; PyTorch Lightning; GPyTorch (for Gaussian Processes); Matplotlib & NumPy
